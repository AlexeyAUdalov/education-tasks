...
public:
    ...
    template <typename T>
    void SetStopWords(const T& text) {
        for (const T& word : SplitIntoWords(text)) {
            stop_words_.insert(word);
        }
    }

    template <typename T>
    void SetStopWords(const vector<T>& text) {
        for (const T& word : text) {
            if (word != "") {
                stop_words_.insert(word);
            }            
        }
    ...
    template <typename T>
    void SetStopWords(const set<T>& text) {
        for (const T& word : text) {
            if (word != "") {
                stop_words_.insert(word);
            }
